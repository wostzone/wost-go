...
//
// This is an internal method for use by ConnectWithAccessToken and ConnectWithClientCert.
//
...
//
//  hostPort    with address:port for password or certificate authentication
//  userName    to authenticate with. Use plugin ID when using client cert
...
func (mqttClient *MqttClient) connect(
	...
	// TLS for MQTT protocol either certificate or Username/accessToken auth. Websockets are not used.
...
// Disconnect the connection to the MQTT broker and unsubscribe from all addresss and set
...
//
// See ConnectWithAccessToken or ConnectWithClientCert for the two methods of authentication.
